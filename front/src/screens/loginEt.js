...
export default function LoginScreenEt({ navigation }) {
    ...
    function Login() {
        ...
        if (login != "" && password != "") {
            ...
            axios.post("http://localhost:5700/api/v1/etudiant/login", data).then(res => {
                if (res.data.error) {
                ...
                <View style={loginStyle.View}>
                    <Card >
                        <Card.Content>
                            ...
                            <Button onPress={() => navigation.navigate("registerEtd")}>Register</Button>
                        </Card.Content>
