                ...
                >
                    ...
                    <View>
                        ...
                        <Chapters
                            ...
                            duration="20 minutes"
                            title="Introduction"
                            onPress={() => this.props.navigation.navigate('videoAeInit')}
                        />
                        <Chapters
                            num={2}
                            color="#f9e1fc"
                            ...
                            duration="1 minutes"
                            title="Presentation"
                            onPress={() => this.props.navigation.navigate('videoAePresentation')}
                        ...
                        <Chapters
                            ...
                            duration="13 minutes"
                            title="Variables"
                            onPress={() => this.props.navigation.navigate('videoAeVariables')}
                        ...
                        <Chapters
                            ...
                            duration="13 minutes"
                            title="Composites"
                            onPress={() => this.props.navigation.navigate('videoAeComposites')}
                        ...
                        <Chapters
                            ...
                            duration="18 minutes"
                            title="Calques"
                            onPress={() => this.props.navigation.navigate('videoAeCalques')}
